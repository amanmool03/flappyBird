...
const bg = {
    ...
    draw : function(){
        ctx.drawImage(sprite2, this.sX , this.sY,this.w,this.h,this.x,this.y,canvas.width,canvas.height);
    }
...
const bird = {
    ...
    update: function(){
        // if game is get ready bird must flap slowly
        this.period = state.current == state.getReady ? 10 : 5;
        
        // we increment the frame by 1 in each this.period
        this.frame += frames %  this.period == 0 ? 1 : 0;
        
        // frame goes from 0 to 4 then again go to 0
...
const pipes = {
    ...
    update : function(){
            ...
            // if the pipes goes beyond the canvas we delete from the array
                if(p.x + this.w <= 0){
                    this.position.shift();
                    score.value += 1;
                    SCORE_S.play();
